...
Although this is really interesting, what I think would be interesting to look at, would be how these teams connect between each other. Given the dataset being such, I'll examine a social network analysis based on attendance between the two teams over time to see how the structure of the teamed network changes. 

This will take a bit of work to get things set up. 
